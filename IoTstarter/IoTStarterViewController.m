...
- (void)updateAccelLabels
{
    ...
    self.latitude.text = [NSString stringWithFormat:@"latitude: %f", appDelegate.latestLocation.coordinate.latitude];
    self.longitude.text = [NSString stringWithFormat:@"longitude: %f", appDelegate.latestLocation.coordinate.longitude];
}
