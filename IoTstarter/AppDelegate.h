...
@property INTULocationRequestID locationRequestID; // KAD added for INTULocationManager


// Accelerometer related properties
@property (nonatomic) BOOL isAccelEnabled;
@property (strong, nonatomic) CMMotionManager *motionManager;
@property (strong, nonatomic) CLLocationManager *locationManagerNew;
