...
class LoginViewControllerNew: UIViewController {
...
func didTapLoginButton(_ sender: LoginButton) {
...
func didTapFacebookLoginButton(_ sender: FacebookLoginButton) {
...
func didTapTwitterLoginButton(_ sender: TwitterLoginButton) {
